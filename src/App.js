...
export default class App extends React.Component{
  componentDidMount(){
   ...
   // gameObjects.CHIAMAMI(); //QUESTO FUNZIONA
    ...
    init.addObject(1,1,0.5,"./Engine/Resources/Player.png"); //QUESTO NO PORCA PUTTANA
  }
    ...
    return(
      <div>
        <div class="container">
          ...
          <span id="fps"></span>
          <button id="addObject" width="100" height="50" onClick={function (){
             //init.addObject(1,1,0.5,"../Resources/testimage.png");
            }}>Add</button>
        </div>

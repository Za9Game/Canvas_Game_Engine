import {Point, M3x3} from '../Utils/maths';
import VertexShader from '../Shaders/ModelShader/vertex';
import FragmentShader from '../Shaders/ModelShader/fragment';
...
class Material{
	...
	getShader(script, type, booleano){
		let gl = this.gl;
